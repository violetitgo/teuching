				...
				<c:forEach items="${res.resRev.selectRevReport }" var="r">
					<div class="panel panel-info" style="margin: 1em;">
						<div class="panel-heading">
							...
							<a
								href="http://52.78.116.59:8080/teuching/manager/reportdetail.do?revid=${r.report_idx}">
							...
							<ul>
								...
								<c:forEach begin="${res.resRev.pagingRev.blockStart }"
									...
									<li class="active"><span> <a
											href="http://52.78.116.59:8080/teuching/manager/reviewreport.do?revcurrentpage=${pr}">${pr }</a>
									</span></li>
								</c:forEach>
								<c:if
